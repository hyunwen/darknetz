...
void load_weights_TA(float *vec, int length, int layer_i, char type, int transpose)
{
    ...
    //aes_cbc_TA("decrypt", tempvec, length); //For paintext model, code is commented out
...
void save_weights_TA(float *weights_encrypted, int length, int layer_i, char type)
{
   ...
   //aes_cbc_TA("encrypt", weights_encrypted, length); //For paintext model, code is commented out
}
